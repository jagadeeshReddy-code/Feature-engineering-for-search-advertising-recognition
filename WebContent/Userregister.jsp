...
function uservalidate()
{
	...
	if(document.form1.name.value==""||document.form1.pwd.value==""||document.form1.address.value==""||document.form1.dob.value==""||document.form1.emailid.value==""||document.form1.mobile.value=="")
	{
...
%> 
 ...
 <form name="form1" action="Userregisters.jsp" method="post"  enctype="multipart/form-data"  target="_parent">
 ...
 <div class="row">
  ...
  <div class="row">
        <div class="col-sm-4"></div>
        <div class="col-sm-1"><label style="margin-top:5px;">Occupation</label></div>
     <div class="col-sm-3"> <input type="text" placeholder="OCCUPATION" name="occupation"  class="form-control" required></div>
        <div class="col-sm-4"></div>
    </div><br>
