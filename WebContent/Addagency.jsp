        ...
        <div class="collapse navbar-collapse" id="myNavbar" style="font-size:18px;">
            <ul class="nav navbar-nav" role="tablist">
                <li class="nav-item"><a class="nav-link active" href="home.jsp" target="iframe"style="color: white">Home</a></li>
                  <li class="nav-item"><a class="nav-link" href="Uploadadd.jsp" target="iframe"
                        style="color: white">UPLOAD ADVERTISMENT</a></li>
                 <li class="nav-item"><a class="nav-link" href="viewaddsa.jsp" target="iframe"
                        style="color: white">VIEW ADVERTISMENT</a></li> 
                           <li class="nav-item"><a class="nav-link" href="vratingad.jsp" target="iframe"
                        style="color: white">VIEW RATING</a></li>
                 <li class="nav-item"><a class="nav-link" href="viewap.jsp" target="iframe"
                        style="color: white">VIEW PROFILE</a></li>
                          <li class="nav-item"><a class="nav-link" href="changepwdag.jsp" target="iframe"
                        style="color: white">CHANGE PASSWORD</a></li>
                 <li class="nav-item"><a class="nav-link" href="logout.jsp" 
                        style="color: white" target="_parent">LOGOUT</a></li> 
            </ul>
        </div>
    </nav>
 <iframe src="" id="iframe" name="iframe" style="width: 100%;height: 500px;border: none"></iframe>
