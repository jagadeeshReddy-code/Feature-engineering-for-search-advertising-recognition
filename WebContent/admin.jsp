        ...
        <div class="collapse navbar-collapse" id="myNavbar" style="font-size:18px;">
            <ul class="nav navbar-nav" role="tablist">
                <li class="nav-item"><a class="nav-link active" href="home.jsp" target="iframe"style="color: white">Home</a></li>
                  <li class="nav-item"><a class="nav-link" href="viewusers.jsp" target="iframe"
                        style="color: white">VIEW USERS</a></li>
                 <li class="nav-item"><a class="nav-link" href="viewaddagency.jsp" target="iframe"
                        style="color: white">VIEW ADD AGENCY</a></li> 
